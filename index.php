    ...
    <section class="box-login">
        ...
        <div class="box-credenciais">
            <form class="box-form" method="post">
                ...
                <input class="box-form-input" type="text" name="nome" id="nome" placeholder="Nome.." required>
                <label for="senha">Senha</label>
                <input class="box-form-input" type="password" name="senha" id="senha" placeholder="Senha.." required>
